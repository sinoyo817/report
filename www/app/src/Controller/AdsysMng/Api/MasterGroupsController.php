...
/**
 * MasterGroups Controller
 *
 * @method \App\Model\Entity\MasterGroup[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class MasterGroupsController extends AppController
{
    protected $defaultTable = 'MasterGroups';
