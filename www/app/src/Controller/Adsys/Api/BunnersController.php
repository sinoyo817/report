...
use App\Model\Entity\Bunner;
use App\Model\Filter\BunnersCollection;
use ArrayObject;
 ...
 * Bunners Controller
 *
 * @method \App\Model\Entity\Bunner[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class BunnersController extends AppController
{
    protected $defaultTable = 'Bunners';
