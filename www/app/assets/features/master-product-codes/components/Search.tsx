...
import { MasterProductCodeFilterParamType } from "../types";
...
const Search = () => {
    ...
    const { register, reset } = useFormContext<MasterProductCodeFilterParamType>();
    ...
    return (
        <BaseSearchForm<MasterProductCodeFilterParamType>
