...
class MasterProductCodes extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $this->table('master_product_codes', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
        ...
        $this->table('master_product_codes_private', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
