...
class TopImagesTranslations extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $this->table('top_images_translations', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
        ...
        $this->table('top_images_private_translations', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
