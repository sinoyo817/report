...
return [
     ...
     */
    'ViteSetting' => [
        'prudoctionMode' => env('VITE_PRODUCTION_MODE', false),
        'devPort' => env('VITE_DEV_PORT', 5173),
        'manifestFile' => env('VITE_MANIFEST_FILE', 'manifest.json'),
    ],

    /**
     *  Path Config
     *
     * - basePath - サブディレクトリで運用する場合要変更 ex. DS . "foo" . DS . "bar" . DS
     *
     */
    'PathSettings' => [
        'basePath' => env('PATH_BASE_PATH', DS),
        'publicDomain' => env('PATH_PUBLIC_DOMAIN'),
        'privateDomain' => env('PATH_PRIVATE_DOMAIN'),
    ],
];
